...
![img](https://static001.geekbang.org/resource/image/66/a2/66831d1bf402b3a094351ac83bce1aa2.jpg)
...
![img](https://static001.geekbang.org/resource/image/da/8b/da5a213b7d8004a49ac26318c97cd48b.png)
...
![img](https://static001.geekbang.org/resource/image/00/a9/00742101082a488c9f925389fdbb69a9.png)
...
- ![img](https://static001.geekbang.org/account/avatar/00/10/2a/9c/92ed694d.jpg)
...
- ![img](https://static001.geekbang.org/account/avatar/00/11/96/f9/dbbe957f.jpg)
...
- ![img](https://static001.geekbang.org/account/avatar/00/12/96/ce/1d8ee14e.jpg)
...
- ![img](https://static001.geekbang.org/account/avatar/00/10/d9/c6/a295275b.jpg)
...
- ![img](https://static001.geekbang.org/account/avatar/00/11/da/e7/6feaa540.jpg)
...
- ![img](https://static001.geekbang.org/account/avatar/00/0f/9e/6d/fdfd8849.jpg)
...
- ![img](https://static001.geekbang.org/account/avatar/00/10/a8/64/965e0d9b.jpg)
...
- ![img](https://static001.geekbang.org/account/avatar/00/1a/1b/70/547042ee.jpg)
  ...
  b) 二次读取方式
  用户在a处注册了，要在b处访问，因为复制延迟完成无法访问，可以通过按照路由规则去访问a点数据的方式来解决这个问题

  c）存储系统同步方式
  借助数据库本身的同步机制将数据同步过去。

  d）回源读取方式
  跟二次读取差不多，也是按照路由器规则找到对应的节点去拿数据。

  e）重新生成方式
  如果去拿数据，拿不到的话，那么就重新生成。

  4）对大部分用户异地多活。
  对于小部分用户无法保证异地多活，可以通过a）挂公告，b）补体验，c）事后补偿

  oceanbase没有用过，不太清楚，不过任何事情都会有代价的，需要结合具体业务来分析，很难讲可以做到跟业务完全无关的异地多活呀。
...
- ![img](https://static001.geekbang.org/account/avatar/00/10/e0/a8/4e739cf6.jpg)
...
- ![img](https://static001.geekbang.org/account/avatar/00/10/eb/bc/6ccac4bb.jpg)
...
- ![img](https://static001.geekbang.org/account/avatar/00/10/78/db/825d3b7c.jpg)
...
- ![img](https://static001.geekbang.org/account/avatar/00/11/19/a6/7ae63d7e.jpg)
...
- ![img](https://static001.geekbang.org/account/avatar/00/15/2c/45/e8bcf142.jpg)
...
- ![img](https://static001.geekbang.org/account/avatar/00/0f/c1/10/28d5a686.jpg)
...
- ![img](https://static001.geekbang.org/account/avatar/00/0f/fe/c5/3467cf94.jpg)
  ...
  作者回复: 理论上来说，目前的任何网络都有延迟，就算同机房两台机器之间，只要复制就会有延迟，因此绝对意义上的一致性其实不存在的。

  同城异区你理解为将物理上分隔不远的两个机房逻辑上看做同机房就可以了，这样注册的例子就和同机房主备切换一样了